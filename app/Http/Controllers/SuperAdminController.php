...
class SuperAdminController extends Controller
{
    ...
    public function index()
    {
        $profiles   = DB::table('users')
            ...
            ->first();
            return view ('admin.SuperAdminProfile', compact('profiles'));
    }
    ...
    public function edit()
    {
        ...
        if (Auth::user()->role=='super') {
            return view ('admin.SuperAdminProfileEdit', compact('profiles','province','cities'));
        }else{
            return redirect('/');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (Auth::user()->role=='super') {
            return redirect('/SuperAdminProfile/'.$id);
        }else{
            return redirect('/');
        }
    }
