...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/downloads.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:38:50 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><h3>Statistics January 2016</h3></td>
                                        <td><p>[XLSX, 5.13 MB]</p></td>
                                        <td><p class="text-right"><a href="#">Download <i class="fa fa-arrow-circle-o-down"></i></a></p></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-pdf-o"></i></td>
                                        <td><h3>Filename PDF</h3></td>
                                        <td><p>[PDF, 2.59 MB]</p></td>
                                        <td><p class="text-right"><a href="#">Download <i class="fa fa-arrow-circle-o-down"></i></a></p></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-text-o"></i></td>
                                        <td><h3>Readme</h3></td>
                                        <td><p>[TXT, 0.85 MB]</p></td>
                                        <td><p class="text-right"><a href="#">Download <i class="fa fa-arrow-circle-o-down"></i></a></p></td>
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-file-video-o"></i></td>
                                        <td><h3>Promo Video</h3></td>
                                        <td><p>[AVI, 182.07 MB]</p></td>
                                        <td><p class="text-right"><a href="#">Download <i class="fa fa-arrow-circle-o-down"></i></a></p></td>
                                    </tr>
                                </tbody>
                            </table>
