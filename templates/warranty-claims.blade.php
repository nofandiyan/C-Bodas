...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/warranty-claims.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:38:50 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="my-account.html">My Account</a></li>
                        <li class="active">Warranty Claims</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                	...
                	<aside class="sidebar">
                        ...
                        <div class="widget widget-navigation">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="warranty-claims.html">Warranty Claims</a></li>
                            	<li><a href="wishlist.html">Wishlist</a></li>
                ...
                <div class="col-sm-9">
                    <article class="account-content">
                        ...
                        <div class="table-responsive border">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th class="col-xs-4 hidden-sm">Product Name</th>
                                    <th class="col-xs-1">Status</th>
                                    <th class="col-xs-1"></th>
                                </tr>
                                <tr>
                                    <td><a href="single-claim.html">#5712</a></td>
                        ...
                        <a href="add-claim.html" class="btn btn-primary"><i class="fa fa-plus-circle"></i> New Warranty Claim</a>
                    </article>
                </div>
            </div>
        </div>
