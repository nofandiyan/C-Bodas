...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/add-address.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:41:49 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
                	...
                	<aside class="sidebar">
                        ...
                        <div class="widget widget-navigation">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="address.html">My Address</a></li>
                ...
                <div class="col-sm-9">
                    <article class="account-content">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Company</label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Phone<span class="required">*</span></label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Address Line 1<span class="required">*</span></label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Address Line 2</label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">City<span class="required">*</span></label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Zip / Postal Code<span class="required">*</span></label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Country<span class="required">*</span></label>
                                <div class="col-md-8 col-lg-9">
