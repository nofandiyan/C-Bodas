...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/single-claim.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:41:49 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
    ...
    <section class="breadcrumb-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-xs-6">
                    <h2>My Account</h2>
                    <p>Single Warranty Claim</p>
                </div>
                <div class="col-xs-6">
                    <ol class="breadcrumb">
                        <li><a href="index.html">Home</a></li>
                        <li><a href="my-account.html">My Account</a></li>
                        <li class="active">Single Warranty Claim</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                	...
                	<aside class="sidebar">
                        ...
                        <div class="widget widget-navigation">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="my-account.html">Account Dashboard</a></li>
                ...
                <div class="col-sm-9">
                    <article class="account-content">
                        <h3>Warranty Claim #5712</h3>
                        <div class="order-meta">
                            <div class="row">
                                <div class="col-xs-4">
                                    <span class="label label-lg label-warning order-status">Pending</span>
                                </div>
                                <div class="col-xs-8">
                                    <ul class="list-inline order-action">
                                        ...
                                        <li><a href="#" class="btn btn-primary btn-sm">Cancel Claim</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <p>Maecenas vestibulum dolor non purus vestibulum, at lobortis turpis efficitur. Maecenas venenatis elit vitae elit placerat semper. Suspendisse at justo vitae ipsum tincidunt fringilla et vel nibh. In mattis nunc non tincidunt auctor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <h4>Record of receipt of goods to claim:</h4>
                        <div class="row">
                        	<div class="col-xs-4">
                            	<b>Date of Receipt</b>
                            	<p>4.2.2016</p>
                            ...
                            <div class="col-xs-12">
                            	<b>Warrnaty Claim Reason</b>
                            	<p>Maecenas venenatis elit vitae elit placerat semper. Suspendisse at justo vitae ipsum tincidunt fringilla et vel nibh. In mattis nunc non tincidunt auctor.</p>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>U-187423</td>
                                    <td class="hidden-sm">Fusce Aliquam <span class="grey">(M, Black, Esprit)</span></td>
                                    <td>1N50280</td>
                                    <td>1</td>
                                </tr>
                            </table>
