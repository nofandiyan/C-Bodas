...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/add-claim.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:41:49 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
                    ...
                    <article class="account-content">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Product Code</label>
                                <div class="col-md-6 col-lg-6">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Serial Number</label>
                                <div class="col-md-6 col-lg-6">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-lg-3 control-label">Invoice Number</label>
                                <div class="col-md-6 col-lg-6">
                                    <input type="text" class="form-control" placeholder="">
                                </div>
                            </div>
