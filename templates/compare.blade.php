...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:36:07 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
            ...
            <div class="account-content compare">
                ...
                <div class="table-responsive">
                    <table id="table-compare" class="table">
                        ...
                        <tr>
                            <th></th>
                            <th class="accept"><i class="fa fa-arrows btn btn-primary hidden-xs"></i><i class="fa fa-times btn btn-primary"></i></th>
                            <th class="accept"><i class="fa fa-arrows btn btn-primary hidden-xs"></i><i class="fa fa-times btn btn-primary"></i></th>
                            <th class="accept"><i class="fa fa-arrows btn btn-primary hidden-xs"></i><i class="fa fa-times btn btn-primary"></i></th>
                            <th class="accept"><i class="fa fa-arrows btn btn-primary hidden-xs"></i><i class="fa fa-times btn btn-primary"></i></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><img src="assets/images/products/product-1.jpg" class="img-responsive center-block" alt=""><a href="single-product.html">Fusce Aliquam</a></td>
                            <td><img src="assets/images/products/product-2.jpg" class="img-responsive center-block" alt=""><a href="single-product.html">Fusce Aliquam</a></td>
                            <td><img src="assets/images/products/product-3.jpg" class="img-responsive center-block" alt=""><a href="single-product.html">Fusce Aliquam</a></td>
                            <td><img src="assets/images/products/product-4.jpg" class="img-responsive center-block" alt=""><a href="single-product.html">Fusce Aliquam</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="title"></td>
                            <td><a class="btn btn-primary">Add to Cart</a></td>
                            <td><a class="btn btn-primary">Add to Cart</a></td>
                            <td><a class="btn btn-primary">Add to Cart</a></td>
                            <td><a class="btn btn-primary">Add to Cart</a></td>
                        </tr>
