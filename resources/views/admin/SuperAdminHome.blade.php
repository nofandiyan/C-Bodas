            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br>
                        <a href="/SuperAdminProfile/{{$profiles->id}}" class="btn btn-info" role="button">Lihat Profil</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div id="listUser" class="panel-collapse collapse" align="center">
                                    <h4><label>List User</label></h4>
                                        <div id="accordionUser">
                                            <div class="panel">
                                                <div align="center">
                                                    <button class="btn btn-info clickable" data-toggle="collapse" data-parent="#accordionUser" data-target="#listAdmin">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle">
                                                              Admin
                                                            </a>
                                                ...
                                                <br>
                                                    <div id="listAdmin" class="panel-collapse collapse showHideLapak" align="center">
                                                    <h4><label>List Admin</label></h4>
                                                      <table class="table table-hover" style="table-layout: fixed;">
                                                        <thead>
                                                          <tr>
                                                        ...
                                                        <?php $i=1; ?>
                                                            @foreach($admin as $adm)
                                                                  <tr>
                                                                    <td class="short">{{$adm->id}}</td>
                                                                    <td class="short">{{$adm->name}}</td>
                                                                    <td><a href="viewAdminProfile/{{$adm->id}}" class="btn btn-info" role="button">Detail</a></td>
                                                                  </tr>
                                                              <?php $i++; ?>
                                                            @endforeach
                                                        </tbody>
