                                    ...
                                    <div class="col-sm-9">
                                    	<div class="product-body">
                                            ...
                                            <span class="price">
                                                ...
                                                <span class="amount">Rp 17.200.000</span>
                                            </span>
                            	...
                            	<div class="row">
                                	<div class="col-sm-3">
                                    	<div class="product-overlay">
                                            <div class="product-mask"></div>
                                            <a href="single-product.html" class="product-permalink"></a>
                                        	<img style="border:0px; width:300px; height:200px;" src="assets/images/products/Peternakan/sapifh.jpg" class="img-responsive" alt="">
                                    ...
                                    <div class="col-sm-9">
                                    	<div class="product-body">
                                            ...
                                            <span class="price">
                                                <span class="amount">Rp 13.000.000</span>
                                            </span>
                                            <p>Sapi FH </p>
                                            <div class="buttons">
                                                <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-exchange"></i></a>
                            	...
                            	<div class="row">
                                	<div class="col-sm-3">
                                    	<div class="product-overlay">
                                            <div class="product-mask"></div>
                                            <a href="single-product.html" class="product-permalink"></a>
                                        	<img style="border:0px; width:300px; height:200px;" src="assets/images/products/Peternakan/sapipo.jpg" class="img-responsive" alt="">
                                    ...
                                    <div class="col-sm-9">
                                    	<div class="product-body">
                                            ...
                                            <span class="price">
                                                <span class="amount">Rp 14.000.000</span>
                            	...
                            	<div class="row">
                                	<div class="col-sm-3">
                                    	<div class="product-overlay">
                                            <div class="product-mask"></div>
                                            <a href="single-product.html" class="product-permalink"></a>
                                        	<img style="border:0px; width:300px; height:200px;" src="assets/images/products/Peternakan/fhbetina.jpg" class="img-responsive" alt="">
                                            <div class="product-quickview">
                                                <a class="btn btn-quickview" data-toggle="modal" data-target="#product-quickview">Quick View</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-9">
                                    	<div class="product-body">
                                            ...
                                            <span class="price">
                                                <span class="amount">Rp 13.500.000<br></span>
                                            </span>
                                            <p>Sapi FH betina 210 Kg </p>
                                            <div class="buttons">
                                                <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-exchange"></i></a>
                                                <a href="#" class="btn btn-primary btn-sm add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-heart"></i></a>
                                    ...
                                    <div class="col-sm-9">
                                    	<div class="product-body">
                                            ...
                                            <span class="price">
                                                ...
                                                <span class="amount">Rp 15.000.000</span>
                                            </span>
                            	...
                            	<div class="row">
                                	<div class="col-sm-3">
                                    	<div class="product-overlay">
                                            <div class="product-mask"></div>
                                            <a href="single-product.html" class="product-permalink"></a>
                                        	<img style="border:0px; width:300px; height:200px;" src="assets/images/products/Peternakan/sapibali.jpg" class="img-responsive" alt="">
                                    ...
                                    <div class="col-sm-9">
                                    	<div class="product-body">
                                            ...
                                            <span class="price">
                                                <span class="amount">Rp 13.300.000</span></del>
                                               
                                            </span>
                                            <p>Sapi Bali Jantan.</p>
                                            <div class="buttons">
                                                <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-exchange"></i></a>
                                                <a href="#" class="btn btn-primary btn-sm add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-heart"></i></a>
