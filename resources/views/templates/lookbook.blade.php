...
<!-- Mirrored from demos.pixelized.cz/umarket/v1.1/main/lookbook.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Apr 2016 15:38:49 GMT -->
<head>
    <!-- ==========================
    	Meta Tags 
    =========================== -->
...
<body>
        ...
        <div class="container">
        	<div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <img src="assets/images/clients/7.png" class="img-responsive center-block" alt="">
                </div>
            </div>
        	<h2>Some Cool Title</h2>
            <p>Maecenas velit leo, congue ut ligula non, consectetur dictum est. Etiam mollis erat et odio semper sollicitudin. Etiam accumsan magna augue, non dapibus urna aliquam ac. Curabitur sit amet malesuada arcu. Integer quis ex metus. Etiam blandit venenatis quam, eu porta elit viverra at. Nullam bibendum magna quis suscipit blandit.</p>
        </div>
    </section>
    <!-- ==========================
    	LOOKBOOK - END 
    ...
    =========================== -->
    <section class="content lookbook-services border-bottom border-top">
        <div class="container">
            <div class="row">
                <div class="col-xs-6">
                	<h3>Some Cool Title</h3>
					<p>Maecenas velit leo, congue ut ligula non, consectetur dictum est. Etiam mollis erat et odio semper sollicitudin. Etiam accumsan magna augue, non dapibus urna aliquam ac. Curabitur sit amet malesuada arcu. Integer quis ex metus. Etiam blandit venenatis quam, eu porta elit viverra at. Nullam bibendum magna quis suscipit blandit.</p>
                </div>
               	<div class="col-xs-6">
                	<img src="assets/images/lookbook-1.png" class="img-responsive center-block" alt="">
                </div>
    ...
    <!-- ==========================
    	LOOKBOOK SERVICES - START 
    =========================== -->
    <section class="content lookbook-services image-left border-bottom">
        <div class="container">
            <div class="row">
            	<div class="col-xs-6">
                	<img src="assets/images/lookbook-2.png" class="img-responsive center-block" alt="">
                </div>
                <div class="col-xs-6">
                	<h3>Some Cool Title</h3>
					<p>Maecenas velit leo, congue ut ligula non, consectetur dictum est. Etiam mollis erat et odio semper sollicitudin. Etiam accumsan magna augue, non dapibus urna aliquam ac. Curabitur sit amet malesuada arcu. Integer quis ex metus. Etiam blandit venenatis quam, eu porta elit viverra at. Nullam bibendum magna quis suscipit blandit.</p>
